...
tlp.settings.user = tlp.settings.user or {
    ...
    autoCancelBuffs = true, -- Default: true, automatically try to cancel buffs when there's a matching spell in the list below. Call with tlp.xi.actions.cancelBuff
    autoCancelList = {  -- List of buffs to be automatically cancelled
        "Enstone", "Enwater", "Enaero", "Enfire", "Enblizzard", "Enthunder",
        "Stoneskin", "Blaze Spikes", "Ice Spikes", "Shock Spikes", "Sneak"
    },
